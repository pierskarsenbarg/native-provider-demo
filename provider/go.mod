...
require (
	github.com/pierskarsenbarg/native-provider-demo/client v0.0.0-00010101000000-000000000000
...
replace github.com/pierskarsenbarg/native-provider-demo/client => ../client
