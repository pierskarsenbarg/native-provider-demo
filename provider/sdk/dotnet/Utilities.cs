...
namespace MyNamespace.NativeProvider
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/pierskarsenbarg/native-provider-demo";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("MyNamespace.NativeProvider.version.txt");
    ...
    internal sealed class NativeProviderResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public NativeProviderResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
